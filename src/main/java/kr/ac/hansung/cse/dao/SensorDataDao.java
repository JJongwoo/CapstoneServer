...
public class SensorDataDao {
	...
	public Status getCurrnetLocation(String id) {

		String sqlStatement = "select * from sensors where sensor_id = ? order by datetime desc limit 1";
		
		return (Status) jdbcTemplate.queryForObject(sqlStatement, new Object[] {id}, new RowMapper() {
